...
/**
 * Base table primitives. All data tables (density, cost, coverage, comparison)
 * compose these. The wrapper provides horizontal scrolling on small screens.
 */
...
>(({ className, ...props }, ref) => (
  <caption
    ref={ref}
    className={cn("mt-3 px-1 text-left text-xs text-muted-foreground", className)}
    {...props}
  />
));
